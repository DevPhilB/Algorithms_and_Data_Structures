...
/**
 * Complex path calculation with counting all paths
 * 
 * @author Philipp Backes
 *
 */
public class ComplexPathCalculation {
  ...
  public static void main(String[] args) {
    ...
    // int pointCounter = 0;
    /*
     * grid = new int[n + 1][n * n]; for (int i = 0; i < n + 1; i++) { for (int j = 0; j < n * n;
     * j++) { grid[i][j] = pointCounter; pointCounter++; } }
     */
    ...
    System.out.println("Pathes for n=" + n + ": " + pathCounter);
  }
